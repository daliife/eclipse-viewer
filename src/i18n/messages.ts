...
export const en = {
  ...
  solarHitBody:
    'Two things have to happen at once: a new Moon (the Moon between Earth and the Sun) and a pass through a node — one of the two red dots where its tilted orbit crosses the ecliptic. This eclipse is total: the Moon looks a little larger than the Sun.',
  solarMissBody:
    'To cover the Sun you need a new Moon at a node. The Moon is {deg}° off that crossing: it moves about 13° a day, and the 5° tilt sends it above or below the Sun.',
  lunarHitBody:
    'Two things have to happen at once: a full Moon (Earth in the middle) and a pass through a node — one of the two red dots where its orbit crosses the ecliptic. Earth’s umbra falls on the Moon.',
  lunarMissBody:
    'To enter Earth’s shadow you need a full Moon at a node. The Moon is {deg}° off that crossing, so it misses the thin umbra.',
  statusHit: 'Aligned',
  statusMiss: '{deg}° off the node',
  metaDescription:
    'Interactive 3D viewer of a solar or lunar eclipse. See why an eclipse happens only on one day: the Moon’s phase plus a pass through an orbital node.',
  ...
  tour1Title: 'Welcome!',
  tour1Body:
    'On this site you’ll find a 3D scene of a solar or lunar eclipse. Explore the Sun, Earth, and Moon from space or from Earth. You’ll see why it happens, and why it only lines up for one day.',
  tour2Title: 'Why is it so rare?',
  tour2Body:
    'Because an eclipse needs two things at once: the right Moon phase, and a pass through a node — one of the two red dots where its tilted orbit crosses the Sun–Earth plane.',
  ...
  tour4Body:
    'Drag to rotate, scroll or pinch to zoom. The small frame is the view from Earth — you can enlarge it. The gear switches the eclipse type, camera, scale, and guides.',
} as const
...
export const ca: Record<MessageKey, string> = {
  ...
  solarHitBody:
    'Calen dues coses alhora: lluna nova (la Lluna entre la Terra i el Sol) i el pas per un node, un dels dos punts vermells on l’òrbita inclinada creua l’eclíptica. Aquest eclipsi és total: la Lluna es veu una mica més gran que el Sol.',
  solarMissBody:
  ...
  lunarHitBody:
    'Calen dues coses alhora: lluna plena (la Terra al mig) i el pas per un node, un dels dos punts vermells on l’òrbita creua l’eclíptica. L’umbra de la Terra cau sobre la Lluna.',
  lunarMissBody:
  ...
  metaDescription:
    'Visualitzador 3D d’un eclipsi solar o lunar. Entén per què un eclipsi només passa un dia: la fase de la Lluna i el pas per un node de l’òrbita.',
  ...
  tour1Body:
    'En aquest web trobaràs una escena 3D d’un eclipsi solar o lunar. Explora el Sol, la Terra i la Lluna des de l’espai o des de la Terra. Així veus per què passa i per què només s’alinea un dia.',
  tour2Title: 'Per què és tan rar?',
  tour2Body:
    'Perquè un eclipsi necessita dues coses alhora: la fase adequada de la Lluna i el pas per un node, un dels dos punts vermells on l’òrbita inclinada creua el pla Sol–Terra.',
  ...
  tour4Body:
    'Arrossega per girar, i fes zoom amb la rodeta o pessigant. El requadre petit és la vista des de la Terra; el pots ampliar. L’engranatge canvia el tipus d’eclipsi, la càmera, l’escala i les guies.',
}
